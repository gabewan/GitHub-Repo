$ou = Read-Host "Current OU"
$OUPARENT = Read-Host "OU Parent"
$OUGPA = Read-Host "OU GPARENT"
$file = "C:\temp\$ou.csv"

Get-ADComputer -filter * -SearchBase "OU=$OU,OU=$OUPARENT,OU=$OUGPA,DC=nghs,DC=com" | export-csv $file


# SIG # Begin signature block
# MIIFjQYJKoZIhvcNAQcCoIIFfjCCBXoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtPtR2DGXfrawdk5TnefWZEQy
# VaCgggMnMIIDIzCCAgugAwIBAgIQQLH43sgH4IFIu94Hs10bXjANBgkqhkiG9w0B
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTRdV9Q5tNWCYywLRYJLoBuuAFHZDAN
# BgkqhkiG9w0BAQEFAASCAQCou4/8youx6CmdZRSOlkf1k6bp4CXgvjByoefH9Fy7
# G00iHmsYAe7y9XzB4oD6LQBxMPL1Dr5TNs8BdvJE+rXc5I3olgSJqd6sH3zFszOk
# fGuOxpbEpleKCFhyMB+h55rNMxLf7qA2E8RiI0BD4vfXB2Xq1iUtDsKvThWkAULD
# OQRCSXHqs2V/eH9uWc+jWchhDR4ntTcknhCdpz4KVvnmUs3NBHqIsABihYaahWYm
# tZIqXDZX1S5LdawzERgvWdNwZEE7pAbBvgG7JMGuvYUE0ymKSwAFuGz8Xo6I2FkE
# hWOxO2N4IGrkpxudBHsbnWPamuIbZKFWjogm+VNQMgH6
