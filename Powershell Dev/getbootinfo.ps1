$barcode = Read-Host "What is the Hostname:"
$LastBootUpTime = Get-WmiObject Win32_OperatingSystem -Comp $barcode | Select -Exp LastBootUpTime
[System.Management.ManagementDateTimeConverter]::ToDateTime($LastBootUpTime)
# SIG # Begin signature block
# MIIFjQYJKoZIhvcNAQcCoIIFfjCCBXoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6RieM5hVbruTZn1qxqnzNo/n
# KJCgggMnMIIDIzCCAgugAwIBAgIQQLH43sgH4IFIu94Hs10bXjANBgkqhkiG9w0B
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT1UkHRs73LAWvMddOP43qrWZlgpDAN
# BgkqhkiG9w0BAQEFAASCAQA0WljInpH1r0ZGwEk9R8os7mIRsJKUFosAZ5xpp2Lt
# pmksl5lwKtBGYV1wmvyBgnmvpkYbldZpZid1WE37ISpeSIbxPDAFIv9gQNECZvSF
# 9jzvanW43kSWXu+uVVEBGQssee/l+3ZZZNNBMQMl0Pb/JnC1zoO1tSKQ/PoODOt2
# gZ+62VqkscDt7DogiFY2bPlYXquxbLEjr8IEPVlTxM8TrNUO82Z0tCIDCQezc6is
# OVZ+AwkCF3+4MsiBJfoR0EzPOkDjIbzMY+eXQc3X8dsnmSa9NHhUw/0BmBE4BArp
# foYJOvU54ocptB1d4onLUwSYpx99NLFhxC2knXuvAdMk
