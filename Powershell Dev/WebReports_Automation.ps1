...
$ie.Navigate("https://vmwsbigfix01.nghs.com/webreports?page=ExploreComputers#collapseState=4e697d7d6da84550505cf4529556ec9692c5cfde&reportInfo=&filterManager=20b7971d12ad64ed5d75b8551417bca728c3f093&chartSection=&wr_computerTable=701fafa4a2e17e42d8a02027cb10e6357db80f36")
...
#$Devices = Import-Csv "c:\temp\explorecomputers.csv"
#$Excel_Clean = Remove-Item "c:\users\grlewis\downloads\explorecomputers.csv"

$Devices | Sort-Object | Export-Csv 'c:\temp\delete22.csv' -Force -NoTypeInformation