$action = New-ScheduledTaskAction -Execute 'cmd.exe' -Argument '/c Shutdown /r /f'

$trigger =  New-ScheduledTaskTrigger -Daily -At 3am

Register-ScheduledTask -Action $action -Trigger $trigger -TaskName "Restart" -Description "Daily restart for Expeditor Monitors." -Force
# SIG # Begin signature block
# MIIFjQYJKoZIhvcNAQcCoIIFfjCCBXoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUAlz69QfqTphfPlJEOYkCHZxG
# OmqgggMnMIIDIzCCAgugAwIBAgIQQLH43sgH4IFIu94Hs10bXjANBgkqhkiG9w0B
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRuQACLXHcPJXw2mMvVkhQAC4VmHzAN
# BgkqhkiG9w0BAQEFAASCAQCpcTC/jGtPjG1bHLV/+I4t4xSQf2HI9f6FsFy8x1ab
# FZKX1ESgFF2Rs1pjplOICzvS4TqXhEjvIev4wcd2EXRh/s0+W/UaYPUD13na1I2c
# Tqv2ye3TUi8O/Oj0xY4w6LJff3FTGEVaqBbfKBYiHPouWqdbww81RM6pqN96aLJ/
# idkM9OhSMpFcr8xAIKCfWrrLq94eS3mqpckPTG7Wne+QsoihZFng/OMwztUNW6kA
# e6a64HxGgYlDSiBmPzUZcN92XB4tfjdQeFZjMznyinGHfkwpsmPDg7XkWTwjjnei
# bNBuSV6zzmUYhfU9VcvUmTzyh+XIixafMs8+woMgaaab
