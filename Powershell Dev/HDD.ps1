#$computername = get-content -Path 'C:\users\grlewis\Desktop\adgrab.csv'

$computername = get-content -path 'c:\users\grlewis\desktop\adgrab.csv'
$computername
ForEach-Object {
Get-WmiObject Win32_LogicalDisk -ComputerName $computername -Filter "DeviceID='C:'" |
Foreach-Object {$_.Size,$_.FreeSpace} | format-table
} | export-csv "C:\users\grlewis\desktop\results\hddcheck.csv" -NoTypeInformation -Encoding UTF8 -Force
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU6JLS4w+gALbo6l/badmICp7a
# z/+gggMnMIIDIzCCAgugAwIBAgIQQLH43sgH4IFIu94Hs10bXjANBgkqhkiG9w0B
...
# BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQvL8mqXu+QW1PNRwNnJPhChj15MTAN
# BgkqhkiG9w0BAQEFAASCAQBK6dsVYi88MV+52deKs1BvG1U9uWiswmXkPg/GBAZS
# n8tv/ZGFgrGtOVD9L8NjuGx+ZJCrUutDaypa0A4E31e5qdcmQtbyktEARslAECrF
# tt0+dy9Q48YcC/BA5oUcjBer1A3nPdU+e/AVXns+V/CiaAMfxTdHH19DxRFFC1bZ
# +hzl3Gf5lkenOTIdtgF+sL29YLjTVNpKhiYZSm/fpOLvISm0zzHbLCaXtCa4Nk2b
# zK/H07UZDSr0g95BzhNOi6QDgMEPMQJMos7A33xdGhCVjxHhP4NjuQF18sxif6Ce
# g9RrLfwoJlszemXPnPsCOemX8oYgh7ZpvE4ZCKVbfOz1
