...
$PrinterConnections_FS = $PrinterConnections | Where-Object {$_.computername -like "102FSCPC007"}
...
$Temp_Objects.Printers = [System.Collections.Generic.List[System.Object]]::New()
$UserHivesLoaded = [System.Collections.Generic.List[System.Object]]::New()

$Temp_Objects.ComputerName = $device.ComputerName

$Get_Printers_AllUsers = (Get-PrinterInformation -ComputerName $device.ComputerName).Printers
$Temp_Objects.Printers.Add($Get_Printers_AllUsers)





$Device_Printer_Information.Add($Temp_Objects)
}
