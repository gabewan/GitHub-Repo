...
$GlobalDelete = [System.Collections.Generic.List[System.Object]]::New()
 ...
 foreach ($Name in $ComputerName) {
            ...
            $GlobalProfileObject.computername = $Computername
...
$check_printerinfo = $PrinterInformation |  select Printers,Computername 

foreach ($Printer in $check_printerinfo) {

 $Export_printer_object = [pscustomobject]@{
        ComputerName = $null
        Printers     = $null
    }
   $Export_printer_object.Computername = $printer.Computername
   $Export_printer_object.Printers = $printer.printers
   $GlobalDelete.add($Export_printer_object)
}